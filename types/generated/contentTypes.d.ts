...
export interface ApiJournalJournal extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    images_en: Schema.Attribute.Media<'images', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::journal.journal'
    >;
    pdf_en: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    pdf_ru: Schema.Attribute.Media<'images' | 'videos' | 'audios' | 'files'> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
...
export interface ApiMapMap extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    location_text: Schema.Attribute.Text &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    publishedAt: Schema.Attribute.DateTime;
    region_list: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiNewNew extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    card_text: Schema.Attribute.Text &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiRegionListRegionList extends Struct.CollectionTypeSchema {
  collectionName: 'region_lists';
  info: {
    displayName: 'Region list';
    pluralName: 'region-lists';
    singularName: 'region-list';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiRegionRegion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    gallery: Schema.Attribute.Component<'region.gallery', true> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::region-list.region-list': ApiRegionListRegionList;
